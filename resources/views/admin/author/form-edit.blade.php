...
@section('title', trans('admin/author.edit_author'))
@section('content')
<div class="m-content">
    <div class="container">
        <div class="row">
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">
                                    {{ trans('admin/author.edit_author') }}
                                </h3>
                            </div>
                        </div>
                    </div>
                    <form enctype="multipart/form-data"
                    action="{{ route('author.update', ['author' => $author->id]) }}"
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="text" name="name" class="form-control m-input" value="{{ $author->name }}" placeholder="">
                                        @if($errors)
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" name="birthday" class="form-control m-input" value="{{ Helper::formatDate($author->birthday, 'm/d/Y') }}" id="m_datepicker_3" />
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        ...
                                        @endif
                                        <div class="">
                                            <img id="imageTarget" src="{{ asset('storage/' . $author->avatar) }}" class="img-responsive" width="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
