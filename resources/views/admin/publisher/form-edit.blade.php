...
@section('title', trans('admin/publisher.edit_publisher'))
@section('content')
<div class="m-content">
    <div class="container">
        <div class="row">
                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                ...
                                <h3 class="m-portlet__head-text">
                                    {{ trans('admin/publisher.edit_publisher') }}
                                </h3>
                            </div>
                        </div>
                    </div>
                    <form enctype="multipart/form-data"
                    action="{{ route('publisher.update', ['publisher' => $publisher->id]) }}"
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="text" name="name" class="form-control m-input" value="{{ $publisher->name }}" placeholder="">
                                        @if($errors)
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="text" name="address" class="form-control m-input" value="{{ $publisher->address }}" placeholder="">
                                        @if($errors)
                                ...
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        ...
                                        @endif
                                        <div class="">
                                            <img id="imageTarget" src="{{ asset('storage/' . $publisher->image) }}" class="img-responsive" width="100">
                                        </div>
                                    </div>
                                </div>
                            </div>
