...
@section('title', trans('admin/book.create_book'))
@section('content')
<div class="m-content">
    <div class="container">
        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet__body">
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="text" name="title" class="form-control m-input" value="{{ old('title') }}" placeholder="">
                                        @if($errors)
                            ...
                            <div class="col-md-6">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="number" name="quantity" class="form-control m-input" value="{{ old('quantity') }}" placeholder="">
                                        @if($errors)
